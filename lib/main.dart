    ...
    MultiProvider(
      ...
      providers: [
        Provider<CallRepository>(
          create: (_) => CallRepository(firestore: FirebaseFirestore.instance),
        ),
        ProxyProvider<CallRepository, CallController>(
          create: (_) => CallController(
              callRepository: Provider.of<CallRepository>(_, listen: false)),
          update: (_, callRepository, __) =>
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void callUser() {
    ...
    return callController.makeCall(
      context,
      "receiver name",
      "4rec3v",
      "",
